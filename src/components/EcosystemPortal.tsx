            ...
            >
                <Paper
                    sx={{
                        ...
                        boxShadow: '0 32px 64px rgba(0,0,0,0.7), 0 0 100px rgba(0, 245, 255, 0.05)',
                        overflow: 'hidden'
                    }}
                >
                    ...
                    <Box sx={{ p: 2, bgcolor: 'rgba(0, 245, 255, 0.03)', display: 'flex', justifyContent: 'center' }}>
                        <Typography variant="caption" sx={{ color: 'rgba(0, 245, 255, 0.4)', fontWeight: 700, letterSpacing: '0.05em' }}>
                            SECURED BY WHISPERR CORE
                        </Typography>
                    </Box>
                </Paper>
            </motion.div>
